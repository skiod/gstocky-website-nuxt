...
async function sendEmail(){
  ...
  grecaptcha.ready(()=> {
    grecaptcha.execute('6LetDZEmAAAAAEr9EdTVoDeg6-saEQYhXVSlrQhO', {action: 'submit'}).then( async (token) => {
      ...
      var raw = JSON.stringify({
        ...
        const response = await fetch("https://api.gstocky.com/contact-us", {
          method: 'POST',
          headers: myHeaders,
          body: raw,
          redirect: 'follow'
